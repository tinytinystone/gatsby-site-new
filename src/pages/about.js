...
const About = () => {
  return (
    <>
      ...
      <p>
        패스트캠퍼스에서 프로그래밍 교육 프로덕트를 기획하는 일을 했습니다. 좋은
        교육 과정을 만들기 위해 개발 공부를 시작했다가, 그 공부가 재밌어서
        개발자가 되었습니다.
      </p>
      <p>
      ...
      <p>
        함께 일하는 동료들을 잘 인터뷰하여 보이지 않는 요구사항을 찾아내고, 이를
        통해 더 좋은 구현물을 만들기 위해 노력하고 있습니다. 비전공자의 장점을
        살리되, 부족한 부분은 계속 채워나가고자 컴퓨터과학의 기초를 계속 공부해
        나가고 있습니다.
      </p>
      <p>
        사용자에게 필요한 제품이라면 언어와 기술의 제한 없이 구현해 내고, 문제를
        잘 정의하고 해결해 내는 유능한 소프트웨어 엔지니어가 되는 것을 목표로
        하고 있습니다.
      </p>
      <h3>skill</h3>
      <dl>
      ...
      <ul>
        ...
        <li>
          <a className="link_underline" href="https://github.com/tinytinystone">
            github
          </a>
        </li>
        <li>
